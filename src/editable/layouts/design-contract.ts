...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#29301f',
  '--slot4-panel-bg': '#e2e4dc',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#626858',
  '--slot4-soft-muted-text': '#858b7c',
  '--slot4-accent': '#84934A',
  '--slot4-accent-fill': '#84934A',
  '--slot4-accent-soft': '#e3e8d2',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#343a27',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfe1d8',
  '--slot4-cream': '#f7f7f3',
  '--slot4-warm': '#e2e4dc',
  '--slot4-lavender': '#ECECEC',
  '--slot4-gray': '#e5e5e1',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#ECECEC',
  '--editable-page-text': '#29301f',
  '--editable-container': '1180px',
  '--editable-border': '#cdd1c0',
  '--editable-nav-bg': '#ECECEC',
  '--editable-nav-text': '#29301f',
  '--editable-nav-active': '#84934A',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#84934A',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#343a27',
